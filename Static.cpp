...
/*
************************************************************
** You can Change these two function as your requirement
*/
...
{
    return 2*x-4-0; // this is the first derivative of the function
}
/*
*************************************************************
*/
...
public:
    ...
    long double horner(long double x)
    {
        long double ans = a[n];
        for (int i = n-1; i >= 0; i--)
        {
